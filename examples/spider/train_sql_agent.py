...
import pandas as pd
from sql_agent_mysql import LitSQLAgent
...
RL_TRAINING_CONFIG: Dict[str, Any] = {
    ...
    "data": {
        "train_files": "/home/user/cx/new_data/agent-lightning/examples/spider/data_claude/train_data.parquet",
        "val_files": "/home/user/cx/new_data/agent-lightning/examples/spider/data_claude/test_data.parquet",
        "train_batch_size": 32,
        "max_prompt_length": 15000,
        "max_response_length": 4096,
        "truncation": "truncate_left",
    },
    "actor_rollout_ref": {
        "rollout": {
        ...
        "model": {
            "path": "/home/user/Downloads/Qwen2.5-Coder-1.5B-Instruct",
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        choices=["fast", "qwen", "llama", "npu"],default="qwen",
